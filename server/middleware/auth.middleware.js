...
module.exports = (req, res, next) => {
  ...
  try {
    ...
    if (!data) {
      //Таким образом мы проверим, корректный ли токен. Если токен не корректный, то пользователь не будет авторизован.
      return res
        .status(401)
        .json({ error: { message: 'Вы не авторизованы! Войдите пожалуйста в систему.' }, code: 401 });
    }
